...
//     version 1.14.2
//     from Assets/Imported Assets/Synty/AnimationBaseLocomotion/Samples/Scripts/InputSystem/Controls(Backup).inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Imported Assets/Synty/AnimationBaseLocomotion/Samples/Scripts/InputSystem/Controls(Backup).inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @ControlsBackup: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @ControlsBackup()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""Controls(Backup)"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@ControlsBackup()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, ControlsBackup.Player.Disable() has not been called.");
    }
    ...
    {
        private @ControlsBackup m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@ControlsBackup wrapper) { m_Wrapper = wrapper; }
        /// <summary>
